...
export default function ProgressCircle({
  ...
  const innerCircleRadius = size / 2 - 85;
      ...
      <svg width={size} height={size}>
        ...
        <defs>
          ...
          <clipPath id="myInnerCircle">
            <circle cx="50%" cy="50%" r={innerCircleRadius} fill="#FFFFFF" />
          </clipPath>
        </defs>
        <image
        ...
        <image
          className={isPlaying ? "active" : ""}
          x={size / 2 - innerCircleRadius}
          y={size / 2 - innerCircleRadius}
          width={2 * innerCircleRadius}
